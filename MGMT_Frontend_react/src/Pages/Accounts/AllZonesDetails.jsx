...
const AllZonesDetails = () => {
    ...
    const headers = selectedZone === null ? ["Prabhag Name", "Authorized Receipts", "Pending Receipts", "Authorized Pending", "Authorized Receipt Amount", "Pending Receipt Amount"] : ["Ward", "Total"];
