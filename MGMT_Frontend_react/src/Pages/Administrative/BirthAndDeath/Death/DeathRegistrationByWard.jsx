...
const DeathRegistrationByWard = () => {
  ...
  const tableHeaders = ["झोनचे नाव", "अर्ज", "नोंदणी"];
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      setLoading(true);
      const payload = {
        Request1: `${flag}$death_ZoneSummary$${userId}$${ulbid}~${formatDateForAPI(values.from)}~${formatDateForAPI(values.to)}`,
        Request2: "a",
        Request3: "a",
        Request4: "a",
        Request5: "a",
...
export default DeathRegistrationByWard;
