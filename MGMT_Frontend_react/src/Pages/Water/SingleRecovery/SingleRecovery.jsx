  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        setLoading(true);
        const payload = {
          Request1: `CollectionCenter$prabhag_demcollper$${user.userId}$${orgId}~~`,
          Request2: "a",
          Request3: "a",
          Request4: "a",
          Request5: "a",
        ...
        totalRow.colper = totalRow.demand ? (totalRow.totcol / totalRow.demand) * 100 : 0;
        ...
        totalRow.colper = Number(totalRow.colper.toFixed(2));
